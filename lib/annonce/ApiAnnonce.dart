...
class ApiAnnonce {
  ...
  Future<void> postAnnonce(String post, image) async {
    var request = http.MultipartRequest(
        'POST',
        Uri.parse(
            'http://192.168.1.21/ISIMM_eCampus/public/api/ajouter_annonce'));
  ...
  Future<void> deleteAnnouncement(int annonceId) async {
      ...
      final response = await http.post(
        Uri.parse('http://192.168.1.21/ISIMM_eCampus/public/api/supprimer_annonce/$annonceId'),
        headers: {
          'Authorization': 'Bearer 8|vPWnz3i58JNfNRHMYL2w48bS5KFjkxgvgFFqYVbd',
  ...
  UpdateAnnonce(String description, int idannonce) async {
    http.Response response = await http.post(Uri.parse(
        "http://192.168.1.21/ISIMM_eCampus/public/api/update_annonce/${idannonce}"),
        body: {
  ...
  LikeAnnonce(idAnnonce) async {
    http.Response response = await http.post(Uri.parse("http://192.168.1.21/ISIMM_eCampus/public/api/like/$idAnnonce",
    ),
        headers: {
          'Authorization': 'Bearer 8|vPWnz3i58JNfNRHMYL2w48bS5KFjkxgvgFFqYVbd',
          'Accept': 'application/json'
  ...
  void DisLikeAnnonce(idAnnonce)async{
    http.Response response = await http.post(Uri.parse("http://192.168.1.21/ISIMM_eCampus/public/api/deslike/1"),
        headers: {
          'Authorization': 'Bearer 8|vPWnz3i58JNfNRHMYL2w48bS5KFjkxgvgFFqYVbd',
          'Accept': 'application/json'
        });
