...
class ExamenApi{
  ...
  late List list;
  // envoie cours
  PostExamen(String title, String subtitle, File pdf) async {
    http.MultipartRequest response = await http.MultipartRequest('POST',
      ...
      Uri.parse(
          "http://192.168.1.37/ISIMM_eCampus/public/api/upload_examen"),
    );
  ...
  downloadExamen(filename) async {
    ...
    http.Response response = await http.get(Uri.parse(
        'http://192.168.1.37/ISIMM_eCampus/public/api/download_examen?filename=H1654SBhg8VmuRecqNNL'),
        headers: {
          'Authorization': 'Bearer 34|5swDq3pxoOYX1ZuAeCovj2DW10pjUyr73BXh9uXC',
          'Accept': 'application/json'
        });
  ...
  // Supprimer cours
  DeleteExamen(matier_id, classe_id,idexamen) async {
    http.Response response = await http.post(Uri.parse(
        "http://192.168.1.37/ISIMM_eCampus/public/api/supprimer_examen/$idexamen?matiere_id=1&classe_id=1"),
        headers: {
          'Authorization': 'Bearer 34|5swDq3pxoOYX1ZuAeCovj2DW10pjUyr73BXh9uXC',
          'Content-type': 'application/json',
          'Accept': 'application/json'
  ...
  //Update cours
  UpdateExamen(String title, String subtitle) async {
    http.Response response = await http.post(Uri.parse(
        "http://192.168.1.25/ISIMM_eCampus/public/api/update_cours/2?matiere_id=1&classe_id=1"),
        body: {
          'titre': title,
