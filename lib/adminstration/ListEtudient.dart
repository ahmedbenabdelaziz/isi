                                          ...
                                          child: Padding(
                                            ...
                                            child: Row(
                                              children: [
                                                ...
                                                CircleAvatar(
                                                  radius: 17,
                                                   backgroundImage:NetworkImage("http://192.168.1.37/ISIMM_eCampus/storage/app/public/${annonces[id]['image']}"),
                                                ),
                                                SizedBox(width: 10),
                                                Container(
                                                  width: 170,
                                                ...
                                                Container(
                                                  width: 100,
                                                  child: Text(
                                                    annonces[id]['classe'][id]['nom'] ?? "Texte vide",
                                                    overflow: TextOverflow.ellipsis,
                                                  ),
                                                ),
                                                Container(
                                                    width: 100
                                                    ,child: Text("${annonces[id]['nom']}")),
                                                Container(
                                                    width: 137
